...
// add `spacer_t` of clearance behind the module/pins. No change to the front
// shell or rear plate: 4 corner pads pass the (longer) M3 screws straight
// through to the existing front bosses, and a registration spigot nests in the
// front shell's rear opening. Local coords: frame body z in [0, spacer_t];
// spigot in [-spigot_h, 0] (points toward the front shell).

// hollow perimeter frame — the added clearance volume
module spacer_frame() {
