...
// lip catches behind sits at the front-wall inner face. The well + cap stay
// CENTERED on the module; the contact nub is offset toward the top switch but
// stays under the skirt (see btn_above_center), so it clears within this
// centered bore — no extra slot needed.
module button_well() {
