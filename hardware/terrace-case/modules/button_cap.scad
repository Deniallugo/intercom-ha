...
module button_cap() {
    ...
    difference() {
        ...
        // orientation/fixing slice: a flat on the -y bottom (opposite the nub) — visible on the
        // face to orient it, plus a glue gap against the round bore on the skirt to fix rotation
